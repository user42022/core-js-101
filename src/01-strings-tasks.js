...
function encodeToRot13(str) {
  return str.split('').map((e) => {
    if (e.charCodeAt(0) < 65 || e.charCodeAt(0) > 122) {
      return e;
    }
    if (e.charCodeAt(0) < 91 && e.charCodeAt(0) > 64) {
      if (e.charCodeAt(0) + 13 < 91) {
        return String.fromCharCode(e.charCodeAt(0) + 13);
      }
      return String.fromCharCode(e.charCodeAt(0) - 13);
    }

    if (e.charCodeAt(0) < 123 && e.charCodeAt(0) > 96) {
      if (e.charCodeAt(0) + 13 < 123) {
        return String.fromCharCode(e.charCodeAt(0) + 13);
      }
      return String.fromCharCode(e.charCodeAt(0) - 13);
    }
